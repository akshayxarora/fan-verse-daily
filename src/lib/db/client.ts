// Database client for NeonDB - re-export from neon.ts
export { getDb, query, queryOne, transaction, testConnection } from './neon';

// Database initialization SQL (to be run separately)
