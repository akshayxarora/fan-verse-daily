  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        terminal: "bg-transparent border border-primary/50 text-primary font-mono hover:bg-primary/10 hover:border-primary",
        // Subtle muted button
        muted: "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground",
        // Glass effect button
        glass: "bg-foreground/5 backdrop-blur-sm border border-border/50 text-foreground hover:bg-foreground/10 hover:border-primary/30",
      },
      size: {
